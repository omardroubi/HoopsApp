...
class Players: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var eventRefAdd = FIRDatabase.database().reference().child("Players")
    ...
    @IBAction func addPlayer(_ sender: Any) {
        if (name.text! == "" || email.text! == "" || password.text! == "" || birthdate.text! == "" || phoneNumber.text! == "" || salary.text! == "" ) {
            ...
            let newPlayer = Person(name: name.text!, email: email.text!, password: password.text!, role: "Player", salary: Int(salary.text!)!, personalInfo: "Birthday: " + birthdate.text! + " Address & Phone Number: " + phoneNumber.text!)
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            eventRef = FIRDatabase.database().reference()
            eventRef.child("Players").child(playersList[indexPath.row].name).removeValue()
