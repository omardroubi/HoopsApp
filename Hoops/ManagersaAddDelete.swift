...
class ManagersaAddDelete: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var eventRefAdd = FIRDatabase.database().reference().child("Managers")
    ...
    @IBAction func addPlayer(_ sender: Any) {
        if (name.text! == "" || email.text! == "" || password.text! == "" || birthdate.text! == "" || phoneNumber.text! == "" || salary.text! == "" ) {
            ...
            let newPlayer = Person(name: name.text!, email: email.text!, password: password.text!, role: "Manager", salary: Int(salary.text!)!, personalInfo: "Birthday: " + birthdate.text! + " Address & Phone Number: " + phoneNumber.text!)
    ...
    override func viewDidLoad() {
        ...
        eventRef.child("Managers").queryOrderedByKey().observe(.childAdded, with: {
            ...
            self.playersList.append(Person(name: name, email: email, password: password, role: "Manager", salary: salary, personalInfo: personalInfo))
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            eventRef = FIRDatabase.database().reference()
            eventRef.child("Managers").child(playersList[indexPath.row].name).removeValue()
