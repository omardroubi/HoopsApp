...
class StartingLineupCoach: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == UITableViewCellEditingStyle.delete{
            lineupRefwrite.child(lineupList[indexPath.row].game).removeValue()
            lineupList.remove(at: indexPath.row)
            table.reloadData()
